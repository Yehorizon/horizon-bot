...
Знайди 10 найважливіших подій СЬОГОДНІ на тему "{theme_name}" з усього світу.
З кожної події виведи один висновок або закономірність — думку, яка залишиться після того, як новина забудеться.

ВАЖЛИВО: не переказуй новину. Використай її лише як доказ думки.

Формат відповіді:

10 ВИСНОВКІВ ДНЯ

1. [1-2 речення — висновок або закономірність, підкріплена конкретним фактом, іменем або цифрою з сьогоднішніх подій]
2. [те саме]
...і так до 10.
...
ПИТАННЯ ДНЯ
1. [Питання для роздумів читача — пов'язане з темою і висновками дня]
2. [Друге питання]
...
- Кожен висновок починається з думки, а не з опису події
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    msg = (
        ...
        'Щовечора о 19:00 — 10 висновків дня на основі свіжих подій '
